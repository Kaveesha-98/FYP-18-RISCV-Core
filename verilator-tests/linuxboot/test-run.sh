...
#mv src/main/scala/common/configuration.scala .
...
object coreConfiguration {
    ...
    val instructionBase = 0x0000000010000000L
}" > src/main/scala/common/configuration.scala

sbt "runMain testbench"

#mv configuration.scala src/main/scala/common/configuration.scala

cd verilator-tests/linuxboot
